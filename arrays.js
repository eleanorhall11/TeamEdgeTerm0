...
let food = ["curry chicken","jerk chicken","rice","pizza", "tacos", "bbq"]
...
let friends = ['Pepper','Erika','Ogechi','Linda', 'Letti']
let trips = ['Tulum','Cabo','Jamaica','Bali','Maldives']
...
console.log("The favorite food  is " + food[0]);
...
console.log("The favorite food  is " + food[food.length -1]);

console.log("The favorite food  is " + food[5]);
/* -------------------------------------------- 
...
names.splice(1,0, new_name)

// // **** Challenge 3 : Part 1 **** 
// // Update all values of your food array with new food items that you're craving.

let newFood = ['cake', 'icecream','donuts','candy','whipped cream'];

// Replace all elements in the array with new elements
newFood.fill(...food);
...
function multiplyBy1000AndLog(numbers) {
   let multipliedArray = numbers.map(function(numbers) {
      return numbers * 1000;
    });
